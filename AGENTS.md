...
- **Feature work:** This repo is the admin UI; backend feature roadmap and execution workflow live in [atlas-e2e/docs/product/](../atlas-e2e/docs/product/) — see [ATLAS-HIGH-VALUE-BACKLOG.md](../atlas-e2e/docs/product/ATLAS-HIGH-VALUE-BACKLOG.md) and [ATLAS-FEATURE-EXECUTION-PROMPT.md](../atlas-e2e/docs/product/ATLAS-FEATURE-EXECUTION-PROMPT.md) when changes span API and admin.
